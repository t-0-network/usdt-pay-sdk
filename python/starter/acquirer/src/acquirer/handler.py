"""Async callback handlers for the acquirer role.

Each callback is delivered at least once. Your handler must be idempotent:
write under the callback's dedup key, return only after the write is durable.
"""
